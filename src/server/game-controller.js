...
var game = new Phaser.Game(
  ...
  600,
  Phaser.AUTO,
  document.getElementById("phaser")
);
...
Game.getCoordinates = function (layer, pointer) {
  //mapa reagindo a cliques na tela
  Client.sendClick(pointer.worldX, pointer.worldY); //saber onde clique ocorreu
};

Game.addNewPlayer = function (id, x, y) {
  //adiciona sprite na posição xy e armazena sprite correspondente em matriz declarada em game.create conforme id fornecido
